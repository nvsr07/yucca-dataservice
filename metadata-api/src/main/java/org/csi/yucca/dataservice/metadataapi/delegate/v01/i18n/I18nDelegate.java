...
public class I18nDelegate {
	...
	public static String translate(String code, String lang) {
		...
		return translate(code, lang, code);
	}

	public static String translate(String code, String lang, String ifNull) {
	...
	public static List<String> translateMulti(List<String> codes, String lang) {

		lang = safeLanguage(lang);
		List<String> tranlsated = null;
		if (codes != null && codes.size() > 0) {
			tranlsated = new LinkedList<String>();
			for (String code : codes) {
				tranlsated.add(translate(code.trim(), lang));
			}
		}
		return tranlsated;
	}
