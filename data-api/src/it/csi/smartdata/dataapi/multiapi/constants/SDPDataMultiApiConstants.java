...
public interface SDPDataMultiApiConstants {

	public static final long SDP_MAX_DOC_FOR_ORDERBY=100000;
	
	public static final String SDP_WEB_FILTER_PATTERN="/SmartDataOdataMultiApiService.svc/";
	public static final String SDP_WEB_SERVLET_URL="/SDPOdataMultiApiServlet.svc/";
	
	
	public static final String SDP_ODATA_DEFAULT_SERVICE_FACTORY="it.csi.smartdata.dataapi.multiapi.odata.SDPMultiApiServiceFactory";
