...
//				System.out.println("---------------      |"+dateFormat2.format(data)+"|");
	...
	static {
		...
		fieldAppendMap.put(SDPDataApiConstants.ENTITY_SET_NAME_DATASETS+".codSubDomain" ,"info.codSubDomain");
		fieldAppendMap.put(SDPDataApiConstants.ENTITY_SET_NAME_DATASETS+".license" ,"info.license");
		...
		fieldAppendMap.put(SDPDataApiConstants.ENTITY_SET_NAME_DATASETS+".tenantsharing" ,"info.tenantssharing.tenantsharing.tenantCode");
